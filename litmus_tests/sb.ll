...
26:                                               ; preds = %24
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvvEEEEEEE, i64 16), ptr %25, align 8, !tbaa !12
...
51:                                               ; preds = %45
  %52 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 36)
...
60:                                               ; preds = %51, %45
  %61 = load i64, ptr %4, align 8, !tbaa !19
  %62 = icmp eq i64 %61, 0
...
69:                                               ; preds = %55, %53, %39, %35
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %4) #11
  %71 = load i64, ptr %3, align 8, !tbaa !19
  %72 = icmp eq i64 %71, 0
